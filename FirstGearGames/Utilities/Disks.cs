...
namespace FirstGearGames.Utilities.Disks
{
    ...
    public static class Disks
    {
        ...
        public static void WriteToFile(string text, string path, bool formatPath = true)
        {
            ...
            {
                Debug.LogError("ExtIO -> WriteToFile -> path cannot be null.");
                return;
            }
            ...
            {
                Debug.LogError("ExtIO -> WriteToFile -> An error occured during a file write. Error: " + ex.Message + Environment.NewLine + "File path: " + path + Environment.NewLine + "Text: " + text);
            }
        ...
        public static string FormatPlatformPath(string path)
        {
            ...
            if (path == string.Empty)
            {
                Debug.LogError("ExtIO -> FormatResourcePath -> path cannot be empty.");
                return string.Empty;
            }
