...
namespace GameKit.Core.Crafting
{
    ...
    public partial class Crafter : NetworkBehaviour
    {
        ...
        private class CraftingProgress
        {
            ...
            /// </summary>
            public bool Active => (RecipeData != null);
            /// <summary>
            /// Percentage complete.
            /// </summary>
            public float Percent
            {
                get
                {
                    ...
                    return Mathf.Min(1f, _timePassed / RecipeData.CraftTime);
                }
            }
            ...
            /// </summary>
            public float MultipliedCraftTime => ((1f / _speedMultiplier) * RecipeData.CraftTime);
            /// <summary>
            ...
            public void Initialize(RecipeData r, float multiplier)
            {
                RecipeData = r;
                _timePassed = 0f;
        ...
        public delegate void CraftingStartedDel(RecipeData recipe, bool asServer);
        /// <summary>
        /// Called when crafting progresses.
        /// </summary>
        public event CraftingProgressedDel OnCraftingProgressed;
        public delegate void CraftingProgressedDel(RecipeData recipe, float percent, float delta);
        /// <summary>
        /// Called when a crafting result occurs. This could be completed, failed, ect.
        /// </summary>
        public event CraftingResultDel OnCraftingResult;
        public delegate void CraftingResultDel(RecipeData recipe, CraftingResult result, bool asServer);
        #endregion
        ...
        /// </summary>
        private RecipeData _lastCraftedRecipe;
        /// <summary>
        ...
        /// </summary>
        private void BeginCraftingRecipe(RecipeData r, CraftingProgress cp, ref int sequentialCount)
        {
        ...
        private void ProgressCrafting()
        {
            ...
            void Progress(bool asServer)
            {
                ...
                RecipeData recipe = cp.RecipeData;
        ...
        /// </summary>
        /// <param name="cr"></param>
        private void InvokeCraftingResult(RecipeData recipe, CraftingResult cr, bool asServer)
        {
        ...
        private bool TryInvokeNoSpace(RecipeData recipe, bool asServer)
        {
