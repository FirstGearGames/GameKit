...
namespace GameKit.Core.Crafting
{
    ...
    public partial class Crafter : NetworkBehaviour
    {
        ...
        /// </summary>
        [ServerRpc]
        private void ServerCancelCrafting(RecipeData r)
        {
        ...
        /// </summary>
        [ServerRpc]
        private void ServerCraftRecipe(RecipeData r)
        {
            //Did not deserialize, client did something bad.
            if (IsRecipeNull(r, true))
                return;
        ...
        /// </summary>
        private int SetSequentialCount(RecipeData r, ref int sequentialCount)
        {
            //Recipe change.
        ...
        private void CraftingCompleted_Server(RecipeData r)
        {
        ...
        /// <returns></returns>
        private bool IsRecipeNull(RecipeData r, bool kick)
        {
            bool isNull = (r == null);
            if (isNull && kick)
